...
var ASM_CONSTS = {
  1099784: () => { if (document.fullscreenElement) return 1; },  
 1099830: () => { return Module.canvas.width; },  
 1099862: () => { return parseInt(Module.canvas.style.width); },  
 1099910: () => { document.exitFullscreen(); },  
 1099937: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1100010: () => { if (document.fullscreenElement) return 1; },  
 1100056: () => { return Module.canvas.width; },  
 1100088: () => { return screen.width; },  
 1100113: () => { document.exitFullscreen(); },  
 1100140: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100273: () => { return window.innerWidth; },  
 1100299: () => { return window.innerHeight; },  
 1100326: () => { if (document.fullscreenElement) return 1; },  
 1100372: () => { return Module.canvas.width; },  
 1100404: () => { return parseInt(Module.canvas.style.width); },  
 1100452: () => { if (document.fullscreenElement) return 1; },  
 1100498: () => { return Module.canvas.width; },  
 1100530: () => { return screen.width; },  
 1100555: () => { return window.innerWidth; },  
 1100581: () => { return window.innerHeight; },  
 1100608: () => { if (document.fullscreenElement) return 1; },  
 1100654: () => { return Module.canvas.width; },  
 1100686: () => { return screen.width; },  
 1100711: () => { document.exitFullscreen(); },  
 1100738: () => { if (document.fullscreenElement) return 1; },  
 1100784: () => { return Module.canvas.width; },  
 1100816: () => { return parseInt(Module.canvas.style.width); },  
 1100864: () => { document.exitFullscreen(); },  
 1100891: ($0) => { Module.canvas.style.opacity = $0; },  
 ...
 1101123: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1101174: () => { Module.canvas.style.cursor = 'none'; },  
 1101211: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101467: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 1101518: () => { if (document.fullscreenElement) return 1; },  
 1101564: () => { return window.innerWidth; },  
 1101590: () => { return window.innerHeight; },  
 1101617: () => { if (document.pointerLockElement) return 1; }
};
