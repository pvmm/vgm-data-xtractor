...
var ASM_CONSTS = {
  1099688: () => { if (document.fullscreenElement) return 1; },  
 1099734: () => { return document.getElementById('canvas').width; },  
 1099786: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099854: () => { document.exitFullscreen(); },  
 1099881: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099954: () => { if (document.fullscreenElement) return 1; },  
 1100000: () => { return document.getElementById('canvas').width; },  
 1100052: () => { return screen.width; },  
 1100077: () => { document.exitFullscreen(); },  
 1100104: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100237: () => { return window.innerWidth; },  
 1100263: () => { return window.innerHeight; },  
 1100290: () => { if (document.fullscreenElement) return 1; },  
 1100336: () => { return document.getElementById('canvas').width; },  
 1100388: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100456: () => { if (document.fullscreenElement) return 1; },  
 1100502: () => { return document.getElementById('canvas').width; },  
 1100554: () => { return screen.width; },  
 1100579: () => { return window.innerWidth; },  
 1100605: () => { return window.innerHeight; },  
 1100632: () => { if (document.fullscreenElement) return 1; },  
 1100678: () => { return document.getElementById('canvas').width; },  
 1100730: () => { return screen.width; },  
 1100755: () => { document.exitFullscreen(); },  
 1100782: () => { if (document.fullscreenElement) return 1; },  
 1100828: () => { return document.getElementById('canvas').width; },  
 1100880: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100948: () => { document.exitFullscreen(); },  
 1100975: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1101033: () => { return screen.width; },  
 1101058: () => { return screen.height; },  
 1101084: () => { return window.screenX; },  
 1101111: () => { return window.screenY; },  
 1101138: () => { return window.devicePixelRatio; },  
 1101174: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1101227: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1101298: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1101355: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101611: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1101682: () => { if (document.fullscreenElement) return 1; },  
 1101728: () => { return window.innerWidth; },  
 1101754: () => { return window.innerHeight; },  
 1101781: () => { if (document.pointerLockElement) return 1; }
};
