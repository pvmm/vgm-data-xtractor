...
var ASM_CONSTS = {
  1086328: () => { if (document.fullscreenElement) return 1; },  
 1086374: () => { return document.getElementById('canvas').width; },  
 1086426: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086494: () => { document.exitFullscreen(); },  
 1086521: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086594: () => { if (document.fullscreenElement) return 1; },  
 1086640: () => { return document.getElementById('canvas').width; },  
 1086692: () => { return screen.width; },  
 1086717: () => { document.exitFullscreen(); },  
 1086744: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086877: () => { return window.innerWidth; },  
 1086903: () => { return window.innerHeight; },  
 1086930: () => { if (document.fullscreenElement) return 1; },  
 1086976: () => { return document.getElementById('canvas').width; },  
 1087028: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087096: () => { if (document.fullscreenElement) return 1; },  
 1087142: () => { return document.getElementById('canvas').width; },  
 1087194: () => { return screen.width; },  
 1087219: () => { return window.innerWidth; },  
 1087245: () => { return window.innerHeight; },  
 1087272: () => { if (document.fullscreenElement) return 1; },  
 1087318: () => { return document.getElementById('canvas').width; },  
 1087370: () => { return screen.width; },  
 1087395: () => { document.exitFullscreen(); },  
 1087422: () => { if (document.fullscreenElement) return 1; },  
 1087468: () => { return document.getElementById('canvas').width; },  
 1087520: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087588: () => { document.exitFullscreen(); },  
 1087615: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1087673: () => { return screen.width; },  
 1087698: () => { return screen.height; },  
 1087724: () => { return window.screenX; },  
 1087751: () => { return window.screenY; },  
 1087778: () => { return window.devicePixelRatio; },  
 1087814: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087867: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087938: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1087995: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1088251: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1088322: () => { if (document.fullscreenElement) return 1; },  
 1088368: () => { return window.innerWidth; },  
 1088394: () => { return window.innerHeight; },  
 1088421: () => { if (document.pointerLockElement) return 1; }
};
