...
var ASM_CONSTS = {
  1099584: () => { if (document.fullscreenElement) return 1; },  
 1099630: () => { return document.getElementById('canvas').width; },  
 1099682: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099750: () => { document.exitFullscreen(); },  
 1099777: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099850: () => { if (document.fullscreenElement) return 1; },  
 1099896: () => { return document.getElementById('canvas').width; },  
 1099948: () => { return screen.width; },  
 1099973: () => { document.exitFullscreen(); },  
 1100000: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100133: () => { return window.innerWidth; },  
 1100159: () => { return window.innerHeight; },  
 1100186: () => { if (document.fullscreenElement) return 1; },  
 1100232: () => { return document.getElementById('canvas').width; },  
 1100284: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100352: () => { if (document.fullscreenElement) return 1; },  
 1100398: () => { return document.getElementById('canvas').width; },  
 1100450: () => { return screen.width; },  
 1100475: () => { return window.innerWidth; },  
 1100501: () => { return window.innerHeight; },  
 1100528: () => { if (document.fullscreenElement) return 1; },  
 1100574: () => { return document.getElementById('canvas').width; },  
 1100626: () => { return screen.width; },  
 1100651: () => { document.exitFullscreen(); },  
 1100678: () => { if (document.fullscreenElement) return 1; },  
 1100724: () => { return document.getElementById('canvas').width; },  
 1100776: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100844: () => { document.exitFullscreen(); },  
 1100871: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1100929: () => { return screen.width; },  
 1100954: () => { return screen.height; },  
 1100980: () => { return window.screenX; },  
 1101007: () => { return window.screenY; },  
 1101034: () => { return window.devicePixelRatio; },  
 1101070: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1101123: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1101194: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1101251: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101507: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1101578: () => { if (document.fullscreenElement) return 1; },  
 1101624: () => { return window.innerWidth; },  
 1101650: () => { return window.innerHeight; },  
 1101677: () => { if (document.pointerLockElement) return 1; }
};
