...
var ASM_CONSTS = {
  1086360: () => { if (document.fullscreenElement) return 1; },  
 1086406: () => { return document.getElementById('canvas').width; },  
 1086458: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086526: () => { document.exitFullscreen(); },  
 1086553: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086626: () => { if (document.fullscreenElement) return 1; },  
 1086672: () => { return document.getElementById('canvas').width; },  
 1086724: () => { return screen.width; },  
 1086749: () => { document.exitFullscreen(); },  
 1086776: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086909: () => { return window.innerWidth; },  
 1086935: () => { return window.innerHeight; },  
 1086962: () => { if (document.fullscreenElement) return 1; },  
 1087008: () => { return document.getElementById('canvas').width; },  
 1087060: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087128: () => { if (document.fullscreenElement) return 1; },  
 1087174: () => { return document.getElementById('canvas').width; },  
 1087226: () => { return screen.width; },  
 1087251: () => { return window.innerWidth; },  
 1087277: () => { return window.innerHeight; },  
 1087304: () => { if (document.fullscreenElement) return 1; },  
 1087350: () => { return document.getElementById('canvas').width; },  
 1087402: () => { return screen.width; },  
 1087427: () => { document.exitFullscreen(); },  
 1087454: () => { if (document.fullscreenElement) return 1; },  
 1087500: () => { return document.getElementById('canvas').width; },  
 1087552: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087620: () => { document.exitFullscreen(); },  
 1087647: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1087705: () => { return screen.width; },  
 1087730: () => { return screen.height; },  
 1087756: () => { return window.screenX; },  
 1087783: () => { return window.screenY; },  
 1087810: () => { return window.devicePixelRatio; },  
 1087846: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087899: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087970: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1088027: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1088283: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1088354: () => { if (document.fullscreenElement) return 1; },  
 1088400: () => { return window.innerWidth; },  
 1088426: () => { return window.innerHeight; },  
 1088453: () => { if (document.pointerLockElement) return 1; }
};
