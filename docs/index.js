...
var ASM_CONSTS = {
  1099568: () => { if (document.fullscreenElement) return 1; },  
 1099614: () => { return document.getElementById('canvas').width; },  
 1099666: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099734: () => { document.exitFullscreen(); },  
 1099761: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099834: () => { if (document.fullscreenElement) return 1; },  
 1099880: () => { return document.getElementById('canvas').width; },  
 1099932: () => { return screen.width; },  
 1099957: () => { document.exitFullscreen(); },  
 1099984: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100117: () => { return window.innerWidth; },  
 1100143: () => { return window.innerHeight; },  
 1100170: () => { if (document.fullscreenElement) return 1; },  
 1100216: () => { return document.getElementById('canvas').width; },  
 1100268: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100336: () => { if (document.fullscreenElement) return 1; },  
 1100382: () => { return document.getElementById('canvas').width; },  
 1100434: () => { return screen.width; },  
 1100459: () => { return window.innerWidth; },  
 1100485: () => { return window.innerHeight; },  
 1100512: () => { if (document.fullscreenElement) return 1; },  
 1100558: () => { return document.getElementById('canvas').width; },  
 1100610: () => { return screen.width; },  
 1100635: () => { document.exitFullscreen(); },  
 1100662: () => { if (document.fullscreenElement) return 1; },  
 1100708: () => { return document.getElementById('canvas').width; },  
 1100760: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100828: () => { document.exitFullscreen(); },  
 1100855: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1100913: () => { return screen.width; },  
 1100938: () => { return screen.height; },  
 1100964: () => { return window.screenX; },  
 1100991: () => { return window.screenY; },  
 1101018: () => { return window.devicePixelRatio; },  
 1101054: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1101107: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1101178: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1101235: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101491: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1101562: () => { if (document.fullscreenElement) return 1; },  
 1101608: () => { return window.innerWidth; },  
 1101634: () => { return window.innerHeight; },  
 1101661: () => { if (document.pointerLockElement) return 1; }
};
