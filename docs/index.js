...
var ASM_CONSTS = {
  1086200: () => { if (document.fullscreenElement) return 1; },  
 1086246: () => { return document.getElementById('canvas').width; },  
 1086298: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086366: () => { document.exitFullscreen(); },  
 1086393: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086466: () => { if (document.fullscreenElement) return 1; },  
 1086512: () => { return document.getElementById('canvas').width; },  
 1086564: () => { return screen.width; },  
 1086589: () => { document.exitFullscreen(); },  
 1086616: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086749: () => { return window.innerWidth; },  
 1086775: () => { return window.innerHeight; },  
 1086802: () => { if (document.fullscreenElement) return 1; },  
 1086848: () => { return document.getElementById('canvas').width; },  
 1086900: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086968: () => { if (document.fullscreenElement) return 1; },  
 1087014: () => { return document.getElementById('canvas').width; },  
 1087066: () => { return screen.width; },  
 1087091: () => { return window.innerWidth; },  
 1087117: () => { return window.innerHeight; },  
 1087144: () => { if (document.fullscreenElement) return 1; },  
 1087190: () => { return document.getElementById('canvas').width; },  
 1087242: () => { return screen.width; },  
 1087267: () => { document.exitFullscreen(); },  
 1087294: () => { if (document.fullscreenElement) return 1; },  
 1087340: () => { return document.getElementById('canvas').width; },  
 1087392: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087460: () => { document.exitFullscreen(); },  
 1087487: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1087545: () => { return screen.width; },  
 1087570: () => { return screen.height; },  
 1087596: () => { return window.screenX; },  
 1087623: () => { return window.screenY; },  
 1087650: () => { return window.devicePixelRatio; },  
 1087686: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087739: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087810: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1087867: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1088123: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1088194: () => { if (document.fullscreenElement) return 1; },  
 1088240: () => { return window.innerWidth; },  
 1088266: () => { return window.innerHeight; },  
 1088293: () => { if (document.pointerLockElement) return 1; }
};
