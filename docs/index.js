...
var ASM_CONSTS = {
  1099672: () => { if (document.fullscreenElement) return 1; },  
 1099718: () => { return document.getElementById('canvas').width; },  
 1099770: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099838: () => { document.exitFullscreen(); },  
 1099865: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099938: () => { if (document.fullscreenElement) return 1; },  
 1099984: () => { return document.getElementById('canvas').width; },  
 1100036: () => { return screen.width; },  
 1100061: () => { document.exitFullscreen(); },  
 1100088: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100221: () => { return window.innerWidth; },  
 1100247: () => { return window.innerHeight; },  
 1100274: () => { if (document.fullscreenElement) return 1; },  
 1100320: () => { return document.getElementById('canvas').width; },  
 1100372: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100440: () => { if (document.fullscreenElement) return 1; },  
 1100486: () => { return document.getElementById('canvas').width; },  
 1100538: () => { return screen.width; },  
 1100563: () => { return window.innerWidth; },  
 1100589: () => { return window.innerHeight; },  
 1100616: () => { if (document.fullscreenElement) return 1; },  
 1100662: () => { return document.getElementById('canvas').width; },  
 1100714: () => { return screen.width; },  
 1100739: () => { document.exitFullscreen(); },  
 1100766: () => { if (document.fullscreenElement) return 1; },  
 1100812: () => { return document.getElementById('canvas').width; },  
 1100864: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100932: () => { document.exitFullscreen(); },  
 1100959: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1101017: () => { return screen.width; },  
 1101042: () => { return screen.height; },  
 1101068: () => { return window.screenX; },  
 1101095: () => { return window.screenY; },  
 1101122: () => { return window.devicePixelRatio; },  
 1101158: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1101211: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1101282: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1101339: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101595: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1101666: () => { if (document.fullscreenElement) return 1; },  
 1101712: () => { return window.innerWidth; },  
 1101738: () => { return window.innerHeight; },  
 1101765: () => { if (document.pointerLockElement) return 1; }
};
