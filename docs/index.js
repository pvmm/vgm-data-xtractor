...
var ASM_CONSTS = {
  1086296: () => { if (document.fullscreenElement) return 1; },  
 1086342: () => { return document.getElementById('canvas').width; },  
 1086394: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086462: () => { document.exitFullscreen(); },  
 1086489: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1086562: () => { if (document.fullscreenElement) return 1; },  
 1086608: () => { return document.getElementById('canvas').width; },  
 1086660: () => { return screen.width; },  
 1086685: () => { document.exitFullscreen(); },  
 1086712: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1086845: () => { return window.innerWidth; },  
 1086871: () => { return window.innerHeight; },  
 1086898: () => { if (document.fullscreenElement) return 1; },  
 1086944: () => { return document.getElementById('canvas').width; },  
 1086996: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087064: () => { if (document.fullscreenElement) return 1; },  
 1087110: () => { return document.getElementById('canvas').width; },  
 1087162: () => { return screen.width; },  
 1087187: () => { return window.innerWidth; },  
 1087213: () => { return window.innerHeight; },  
 1087240: () => { if (document.fullscreenElement) return 1; },  
 1087286: () => { return document.getElementById('canvas').width; },  
 1087338: () => { return screen.width; },  
 1087363: () => { document.exitFullscreen(); },  
 1087390: () => { if (document.fullscreenElement) return 1; },  
 1087436: () => { return document.getElementById('canvas').width; },  
 1087488: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1087556: () => { document.exitFullscreen(); },  
 1087583: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1087641: () => { return screen.width; },  
 1087666: () => { return screen.height; },  
 1087692: () => { return window.screenX; },  
 1087719: () => { return window.screenY; },  
 1087746: () => { return window.devicePixelRatio; },  
 1087782: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1087835: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1087906: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1087963: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1088219: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1088290: () => { if (document.fullscreenElement) return 1; },  
 1088336: () => { return window.innerWidth; },  
 1088362: () => { return window.innerHeight; },  
 1088389: () => { if (document.pointerLockElement) return 1; }
};
