...
var ASM_CONSTS = {
  1085160: () => { if (document.fullscreenElement) return 1; },  
 1085206: () => { return document.getElementById('canvas').width; },  
 1085258: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085326: () => { document.exitFullscreen(); },  
 1085353: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1085426: () => { if (document.fullscreenElement) return 1; },  
 1085472: () => { return document.getElementById('canvas').width; },  
 1085524: () => { return screen.width; },  
 1085549: () => { document.exitFullscreen(); },  
 1085576: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1085709: () => { return window.innerWidth; },  
 1085735: () => { return window.innerHeight; },  
 1085762: () => { if (document.fullscreenElement) return 1; },  
 1085808: () => { return document.getElementById('canvas').width; },  
 1085860: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1085928: () => { if (document.fullscreenElement) return 1; },  
 1085974: () => { return document.getElementById('canvas').width; },  
 1086026: () => { return screen.width; },  
 1086051: () => { return window.innerWidth; },  
 1086077: () => { return window.innerHeight; },  
 1086104: () => { if (document.fullscreenElement) return 1; },  
 1086150: () => { return document.getElementById('canvas').width; },  
 1086202: () => { return screen.width; },  
 1086227: () => { document.exitFullscreen(); },  
 1086254: () => { if (document.fullscreenElement) return 1; },  
 1086300: () => { return document.getElementById('canvas').width; },  
 1086352: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1086420: () => { document.exitFullscreen(); },  
 1086447: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1086505: () => { return screen.width; },  
 1086530: () => { return screen.height; },  
 1086556: () => { return window.screenX; },  
 1086583: () => { return window.screenY; },  
 1086610: () => { return window.devicePixelRatio; },  
 1086646: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1086699: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1086770: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1086827: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1087083: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1087154: () => { if (document.fullscreenElement) return 1; },  
 1087200: () => { return window.innerWidth; },  
 1087226: () => { return window.innerHeight; },  
 1087253: () => { if (document.pointerLockElement) return 1; }
};
