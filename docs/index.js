...
var ASM_CONSTS = {
  1099704: () => { if (document.fullscreenElement) return 1; },  
 1099750: () => { return document.getElementById('canvas').width; },  
 1099802: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1099870: () => { document.exitFullscreen(); },  
 1099897: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1099970: () => { if (document.fullscreenElement) return 1; },  
 1100016: () => { return document.getElementById('canvas').width; },  
 1100068: () => { return screen.width; },  
 1100093: () => { document.exitFullscreen(); },  
 1100120: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1100253: () => { return window.innerWidth; },  
 1100279: () => { return window.innerHeight; },  
 1100306: () => { if (document.fullscreenElement) return 1; },  
 1100352: () => { return document.getElementById('canvas').width; },  
 1100404: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100472: () => { if (document.fullscreenElement) return 1; },  
 1100518: () => { return document.getElementById('canvas').width; },  
 1100570: () => { return screen.width; },  
 1100595: () => { return window.innerWidth; },  
 1100621: () => { return window.innerHeight; },  
 1100648: () => { if (document.fullscreenElement) return 1; },  
 1100694: () => { return document.getElementById('canvas').width; },  
 1100746: () => { return screen.width; },  
 1100771: () => { document.exitFullscreen(); },  
 1100798: () => { if (document.fullscreenElement) return 1; },  
 1100844: () => { return document.getElementById('canvas').width; },  
 1100896: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1100964: () => { document.exitFullscreen(); },  
 1100991: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1101049: () => { return screen.width; },  
 1101074: () => { return screen.height; },  
 1101100: () => { return window.screenX; },  
 1101127: () => { return window.screenY; },  
 1101154: () => { return window.devicePixelRatio; },  
 1101190: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1101243: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1101314: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1101371: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1101627: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1101698: () => { if (document.fullscreenElement) return 1; },  
 1101744: () => { return window.innerWidth; },  
 1101770: () => { return window.innerHeight; },  
 1101797: () => { if (document.pointerLockElement) return 1; }
};
